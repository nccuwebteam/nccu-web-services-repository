...
<!---DEPRECATED--->
<!---DEPRECATED--->
<cfparam name='attributes.table' default='Alumni_HomecomingRegistrations'>
<!---=====================================================
Example: <cf_getSpreadsheetOutput table='Alumni_HomecomingRegistrations'>
=====================================================--->
<cfquery name='qrySelectRows' datasource='WebDB'>
  SELECT
    *
  FROM
    #attributes.table#
